...
st.write("APP_TOKEN Loaded: ", APP_TOKEN)  # This should show the token or None
...
def run_flow(message: str) -> dict:
    ...
    # Debugging: Print the headers to check the Authorization format
    st.write("Request Headers:", headers)  # This will show the headers with the Bearer Token
